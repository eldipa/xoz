...
uint64_t double_float_to_le(double num) { return internals::impl_double_to_le<uint64_t, 11>(num); }

double double_float_from_le(uint64_t num) { return internals::impl_double_from_le<uint64_t, 11>(num); }
